...
Because we are dealing with nominal data the best way to visualize this is through a bar plot. To make the code simple, I decided to graph each variable against the number of distinct values therein. 
```{r}
